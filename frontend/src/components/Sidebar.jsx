    ...
    const mobileNav = (
      <div className="bottom-nav">
        ...
        {session ? (
          ...
          <button onClick={openAuthModal} className="bottom-nav-item">
            <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round"
                d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
            </svg>
        ...
        <div className="sidebar-content">
          ...
          <nav className="sidebar-nav">
            ...
            {session ? (
              ...
              <button onClick={openAuthModal} className="sidebar-item" style={{ width: '100%', justifyContent: 'flex-start' }}>
                <div className="sidebar-item-icon">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          ...
          <div className="sidebar-footer" style={{ position: 'relative', overflow: 'visible', display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            {session ? (
              ...
              >
                <div className="sidebar-item-icon" style={{ minWidth: 40, width: 40, height: 40 }}>
                  <div style={{ width: 40, height: 40, borderRadius: '50%', background: 'linear-gradient(135deg, rgb(212,175,55), #f59e0b)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#0f172a' }}>
                    <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" /></svg>
                  </div>
                </div>
                {!isNotificationsOpen && (
                  <span className="sidebar-item-text" style={{ fontSize: 13 }}>Sign In / Up</span>
                )}
              </button>
            )}
